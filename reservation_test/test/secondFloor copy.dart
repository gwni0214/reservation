...
void readData() {
  final userCollectionRefrence =
      FirebaseFirestore.instance.collection("reservation").doc("secondFloor");
  userCollectionRefrence.get().then((value) => {print(value.data())});
}

// Widget _timeData?(DocumentSnapshot doc) {
//    final reservation =
//       Reservation(doc['title'], doc['time'], doc['reserved'], doc['members']);
// }
                ...
                builder: (context, snapshot) {
                  ...
                  return Expanded(
                    child: ListView(
                      ...
                      children: [
                        // documents.map((doc) => readData(doc)).toList(),
                      ],
                    ),
                  );
                }
